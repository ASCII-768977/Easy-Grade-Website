...
const CreateAssignmentBody: React.FC<any> = (props) => {
      ...
      return (
        <tbody key={key} className={'assignment-body__content'}>
          <tr>
            ...
            <td className="progress" id={'prograss'}>
              <div className={'progress__bar'}>
                <Progress percent={timePercentage[key]} strokeColor="#096DD9" showInfo={false} />
              </div>
...
export default connect(mapStateToProps)(CreateAssignmentBody);
